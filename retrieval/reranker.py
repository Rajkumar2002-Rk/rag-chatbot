...
def rerank_by_score(
    ...
    Steps:
      ...
      3. Optionally deduplicate: keep only the highest-scoring chunk per
         (source, page)
      4. Return top_k
    ...
    Disable it for small upload collections where every chunk matters.
    ...
    Args:
        ...
        deduplicate: If True, keep one chunk per (source, page).
